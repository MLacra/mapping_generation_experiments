...
DROP TABLE IF EXISTS public.feeling_ma_3_nl0_ce1 CASCADE ;
CREATE TABLE public.feeling_ma_3_nl0_ce1 (
...
DROP TABLE IF EXISTS public.copy_ma_3_nl0_ce0 CASCADE ;
CREATE TABLE public.copy_ma_3_nl0_ce0 (
butter_ma_3_nl0_ae0comp1_joinref_0 text NOT NULL PRIMARY KEY REFERENCES public.feeling_ma_3_nl0_ce1(butter_ma_3_nl0_ae0comp1_joinattr_0), 
stiff_ma_3_nl0_ae2 text NOT NULL, 
close_ma_3_nl0_ae1 text NOT NULL, 
thick_ma_3_nl0_ae0 text NOT NULL);

DROP TABLE IF EXISTS public.crush_cp_3_nl0_ce0 CASCADE ;
CREATE TABLE public.crush_cp_3_nl0_ce0 (
...
DROP TABLE IF EXISTS public.explain_adl_4_nl0_ce0 CASCADE ;
CREATE TABLE public.explain_adl_4_nl0_ce0 (
...
DROP TABLE IF EXISTS public.fruit_ad_3_nl0_ce0 CASCADE ;
CREATE TABLE public.fruit_ad_3_nl0_ce0 (
...
DROP TABLE IF EXISTS public.hollow_adl_3_nl0_ce0 CASCADE ;
CREATE TABLE public.hollow_adl_3_nl0_ce0 (
...
DROP TABLE IF EXISTS public.involve_dl_3_nl0_ce0 CASCADE ;
CREATE TABLE public.involve_dl_3_nl0_ce0 (
...
DROP TABLE IF EXISTS public.sad_ad_4_nl0_ce0 CASCADE ;
CREATE TABLE public.sad_ad_4_nl0_ce0 (
