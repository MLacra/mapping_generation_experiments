...
DROP TABLE IF EXISTS public.question_ma_4_nl0_ce1 CASCADE ;
CREATE TABLE public.question_ma_4_nl0_ce1 (
...
DROP TABLE IF EXISTS public.root_ma_4_nl0_ce0 CASCADE ;
CREATE TABLE public.root_ma_4_nl0_ce0 (
straight_ma_4_nl0_ae1 text NOT NULL, 
complain_ma_4_nl0_ae2 text NOT NULL, 
sad_ma_4_nl0_ae0comp1_joinref_0 text NOT NULL PRIMARY KEY REFERENCES public.question_ma_4_nl0_ce1(sad_ma_4_nl0_ae0comp1_joinattr_0), 
