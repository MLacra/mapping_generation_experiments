DROP SCHEMA IF EXISTS mixed_40_inds_s_cp_ad__src CASCADE;
CREATE SCHEMA mixed_40_inds_s_cp_ad__src;
DROP TABLE IF EXISTS mixed_40_inds_s_cp_ad__src.bent_ma_2_nl0_ce1 CASCADE ;
CREATE TABLE mixed_40_inds_s_cp_ad__src.bent_ma_2_nl0_ce1 (
...
DROP TABLE IF EXISTS mixed_40_inds_s_cp_ad__src.blow_cp_2_nl0_ce0 CASCADE ;
CREATE TABLE mixed_40_inds_s_cp_ad__src.blow_cp_2_nl0_ce0 (
...
DROP TABLE IF EXISTS mixed_40_inds_s_cp_ad__src.branch_ma_1_nl0_ce1 CASCADE ;
CREATE TABLE mixed_40_inds_s_cp_ad__src.branch_ma_1_nl0_ce1 (
...
DROP TABLE IF EXISTS mixed_40_inds_s_cp_ad__src.charge_ma_2_nl0_ce0 CASCADE ;
CREATE TABLE mixed_40_inds_s_cp_ad__src.charge_ma_2_nl0_ce0 (
collection_ma_2_nl0_ae2 text NOT NULL, 
certain_ma_2_nl0_ae0 text NOT NULL, 
sugar_ma_2_nl0_ae1 text NOT NULL, 
door_ma_2_nl0_ae0comp1_joinref_0 text UNIQUE NOT NULL PRIMARY KEY REFERENCES mixed_40_inds_s_cp_ad__src.bent_ma_2_nl0_ce1(door_ma_2_nl0_ae0comp1_joinattr_0));

DROP TABLE IF EXISTS mixed_40_inds_s_cp_ad__src.collection_dl_2_nl0_ce0 CASCADE ;
CREATE TABLE mixed_40_inds_s_cp_ad__src.collection_dl_2_nl0_ce0 (
...
DROP TABLE IF EXISTS mixed_40_inds_s_cp_ad__src.feeling_ma_3_nl0_ce1 CASCADE ;
CREATE TABLE mixed_40_inds_s_cp_ad__src.feeling_ma_3_nl0_ce1 (
...
DROP TABLE IF EXISTS mixed_40_inds_s_cp_ad__src.copy_ma_3_nl0_ce0 CASCADE ;
CREATE TABLE mixed_40_inds_s_cp_ad__src.copy_ma_3_nl0_ce0 (
butter_ma_3_nl0_ae0comp1_joinref_0 text NOT NULL PRIMARY KEY REFERENCES mixed_40_inds_s_cp_ad__src.feeling_ma_3_nl0_ce1(butter_ma_3_nl0_ae0comp1_joinattr_0), 
stiff_ma_3_nl0_ae2 text NOT NULL, 
close_ma_3_nl0_ae1 text NOT NULL, 
thick_ma_3_nl0_ae0 text NOT NULL);

DROP TABLE IF EXISTS mixed_40_inds_s_cp_ad__src.crush_cp_3_nl0_ce0 CASCADE ;
CREATE TABLE mixed_40_inds_s_cp_ad__src.crush_cp_3_nl0_ce0 (
...
DROP TABLE IF EXISTS mixed_40_inds_s_cp_ad__src.effect_adl_2_nl0_ce0 CASCADE ;
CREATE TABLE mixed_40_inds_s_cp_ad__src.effect_adl_2_nl0_ce0 (
...
DROP TABLE IF EXISTS mixed_40_inds_s_cp_ad__src.fruit_ad_3_nl0_ce0 CASCADE ;
CREATE TABLE mixed_40_inds_s_cp_ad__src.fruit_ad_3_nl0_ce0 (
...
DROP TABLE IF EXISTS mixed_40_inds_s_cp_ad__src.great_ad_1_nl0_ce0 CASCADE ;
CREATE TABLE mixed_40_inds_s_cp_ad__src.great_ad_1_nl0_ce0 (
...
DROP TABLE IF EXISTS mixed_40_inds_s_cp_ad__src.hollow_adl_3_nl0_ce0 CASCADE ;
CREATE TABLE mixed_40_inds_s_cp_ad__src.hollow_adl_3_nl0_ce0 (
...
DROP TABLE IF EXISTS mixed_40_inds_s_cp_ad__src.involve_dl_3_nl0_ce0 CASCADE ;
CREATE TABLE mixed_40_inds_s_cp_ad__src.involve_dl_3_nl0_ce0 (
...
DROP TABLE IF EXISTS mixed_40_inds_s_cp_ad__src.mixed_ma_1_nl0_ce0 CASCADE ;
CREATE TABLE mixed_40_inds_s_cp_ad__src.mixed_ma_1_nl0_ce0 (
chin_ma_1_nl0_ae0comp1_joinref_0 text NOT NULL PRIMARY KEY REFERENCES mixed_40_inds_s_cp_ad__src.branch_ma_1_nl0_ce1(chin_ma_1_nl0_ae0comp1_joinattr_0), 
broken_ma_1_nl0_ae1 text NOT NULL, 
brain_ma_1_nl0_ae2 text NOT NULL, 
small_ma_1_nl0_ae0 text NOT NULL);

DROP TABLE IF EXISTS mixed_40_inds_s_cp_ad__src.narrow_adl_1_nl0_ce0 CASCADE ;
CREATE TABLE mixed_40_inds_s_cp_ad__src.narrow_adl_1_nl0_ce0 (
...
DROP TABLE IF EXISTS mixed_40_inds_s_cp_ad__src.nut_cp_1_nl0_ce0 CASCADE ;
CREATE TABLE mixed_40_inds_s_cp_ad__src.nut_cp_1_nl0_ce0 (
...
DROP TABLE IF EXISTS mixed_40_inds_s_cp_ad__src.past_dl_1_nl0_ce0 CASCADE ;
CREATE TABLE mixed_40_inds_s_cp_ad__src.past_dl_1_nl0_ce0 (
...
DROP TABLE IF EXISTS mixed_40_inds_s_cp_ad__src.question_ma_4_nl0_ce1 CASCADE ;
CREATE TABLE mixed_40_inds_s_cp_ad__src.question_ma_4_nl0_ce1 (
count_ma_4_nl1_ae1 text NOT NULL, 
walk_ma_4_nl1_ae0 text NOT NULL, 
sad_ma_4_nl0_ae0comp1_joinattr_0 text NOT NULL PRIMARY KEY, 
involve_ma_4_nl1_ae2 text NOT NULL);

DROP TABLE IF EXISTS mixed_40_inds_s_cp_ad__src.root_ma_4_nl0_ce0 CASCADE ;
CREATE TABLE mixed_40_inds_s_cp_ad__src.root_ma_4_nl0_ce0 (
straight_ma_4_nl0_ae1 text NOT NULL, 
complain_ma_4_nl0_ae2 text NOT NULL, 
sad_ma_4_nl0_ae0comp1_joinref_0 text NOT NULL PRIMARY KEY REFERENCES mixed_40_inds_s_cp_ad__src.question_ma_4_nl0_ce1(sad_ma_4_nl0_ae0comp1_joinattr_0), 
pain_ma_4_nl0_ae0 text NOT NULL);

DROP TABLE IF EXISTS mixed_40_inds_s_cp_ad__src.use_ad_2_nl0_ce0 CASCADE ;
CREATE TABLE mixed_40_inds_s_cp_ad__src.use_ad_2_nl0_ce0 (
