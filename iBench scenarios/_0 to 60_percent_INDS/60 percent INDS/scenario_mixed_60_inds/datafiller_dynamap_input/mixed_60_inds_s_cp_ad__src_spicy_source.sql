...
DROP TABLE IF EXISTS public.shake_ma_6_nl0_ce1 CASCADE ;
CREATE TABLE public.shake_ma_6_nl0_ce1 (
...
DROP TABLE IF EXISTS public.complete_ma_6_nl0_ce0 CASCADE ;
CREATE TABLE public.complete_ma_6_nl0_ce0 (
agency_ma_6_nl0_ae0comp1_joinref_0 text NOT NULL PRIMARY KEY REFERENCES public.shake_ma_6_nl0_ce1(agency_ma_6_nl0_ae0comp1_joinattr_0), 
death_ma_6_nl0_ae2 text NOT NULL, 
amount_ma_6_nl0_ae1 text NOT NULL, 
count_ma_6_nl0_ae0 text NOT NULL);

DROP TABLE IF EXISTS public.complex_ma_5_nl0_ce1 CASCADE ;
CREATE TABLE public.complex_ma_5_nl0_ce1 (
...
DROP TABLE IF EXISTS public.found_ma_4_nl0_ce1 CASCADE ;
CREATE TABLE public.found_ma_4_nl0_ce1 (
...
DROP TABLE IF EXISTS public.fruit_ma_4_nl0_ce0 CASCADE ;
CREATE TABLE public.fruit_ma_4_nl0_ce0 (
science_ma_4_nl0_ae0 text NOT NULL, 
start_ma_4_nl0_ae0comp1_joinref_0 text NOT NULL PRIMARY KEY REFERENCES public.found_ma_4_nl0_ce1(start_ma_4_nl0_ae0comp1_joinattr_0), 
...
DROP TABLE IF EXISTS public.involve_ma_5_nl0_ce0 CASCADE ;
CREATE TABLE public.involve_ma_5_nl0_ce0 (
mention_ma_5_nl0_ae0 text NOT NULL, 
pencil_ma_5_nl0_ae1 text NOT NULL, 
flower_ma_5_nl0_ae0comp1_joinref_0 text NOT NULL PRIMARY KEY REFERENCES public.complex_ma_5_nl0_ce1(flower_ma_5_nl0_ae0comp1_joinattr_0), 
...
DROP TABLE IF EXISTS public.worry_ma_3_nl0_ce1 CASCADE ;
CREATE TABLE public.worry_ma_3_nl0_ce1 (
...
DROP TABLE IF EXISTS public.treat_ma_3_nl0_ce0 CASCADE ;
CREATE TABLE public.treat_ma_3_nl0_ce0 (
language_ma_3_nl0_ae2 text NOT NULL, 
crush_ma_3_nl0_ae0comp1_joinref_0 text NOT NULL PRIMARY KEY REFERENCES public.worry_ma_3_nl0_ce1(crush_ma_3_nl0_ae0comp1_joinattr_0), 
